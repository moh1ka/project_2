...
float *inframe, *outframe, *inter;          /* Input and output frames *///and intermediate frame for processing
...
/*  Initialize and zero fill arrays */  
	...
	inter		= (float *) calloc(FFTLEN, sizeof(float));	/* Array for processing*/
